...
# with command line options: UserCode/TopFromHeavyIons/python/Pyquen_TTbar_TuneZ2_8160GeV_pythia6_cfi.py --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 80X_mcRun2_pA_v4 --beamspot RealisticPbPBoost8TeV2016Collision --step GEN,SIM --era Run2_2016 --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 10 --customise Configuration/StandardSequences/SimWithCastor_cff.py --scenario HeavyIons --era Run2_2016_pA
...
process.load('GeneratorInterface.HiGenCommon.VtxSmearedPbP8TeVBoost_cff')
